    ...
    <section class="py-24 px-6 bg-puglia-pietra">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                ['label' => 'Sport', 'icon' => 'M15 17.5a3.5 3.5 0 1 0 7 0 3.5 3.5 0 0 0-7 0M2 17.5a3.5 3.5 0 1 0 7 0 3.5 3.5 0 0 0-7 0M14 5a1 1 0 1 0 2 0 1 1 0 0 0-2 0M12 17.5V14l-3-3 4-3 2 3h2'],
